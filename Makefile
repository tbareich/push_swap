...
$(PS_NAME): $(OBJS) $(PUSH_SWAP_OBJS) $(VISUALIZATOR_OBJS) $(LIBFT_LIB) \
...
$(C_NAME): $(OBJS) $(CHECKER_OBJS) $(PUSH_SWAP_HEADER) $(VISUALIZATOR_OBJS) \
	$(LIBFT_LIB) $(VISUALIZATOR_HEADER) $(OPERATIONS_OBJS) 
	$(CC) $(CFLAGS) $(SDL_FLAGGS) $(SDL_INCLUDE) $(SDL_LIBS) $(OBJS) $(VISUALIZATOR_OBJS) $(CHECKER_OBJS) $(OPERATIONS_OBJS) $(LIBFT_LIB) \
	-o $(C_NAME) -I. -Ift_printf 

%.o: %.c $(VISUALIZATOR_HEADER) $(PUSH_SWAP_HEADER) 
	$(CC) $(CFLAGS) $(SDL_INCLUDE) -c -o $@  $< -I. -Ivisualization -I$(LIBFT)
